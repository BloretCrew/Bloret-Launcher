...
Item {
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            TextArea {
                                id: inputField
                                anchors.fill: parent; anchors.margins: 6
                                placeholderText: (Backend ? Backend.tr("向 Blora 说些什么... (Enter 发送, Shift+Enter 换行)") : "向 Blora 说些什么... (Enter 发送, Shift+Enter 换行)")
    ...
    Dialog {
        ...
        contentItem: ColumnLayout {
            spacing: 10
            Text { text: (Backend ? Backend.tr("Blora 想要执行写入操作：") : "Blora 想要执行写入操作："); font.pixelSize: 13; font.bold: true; color: Theme.currentTheme.colors.textColor; wrapMode: Text.Wrap; Layout.fillWidth: true }
            Rectangle {
            ...
            ColumnLayout {
                ...
                spacing: 4
                Text { text: (Backend ? Backend.tr("Blora 的理由：") : "Blora 的理由："); font.pixelSize: 11; font.bold: true; color: Theme.currentTheme.colors.textSecondaryColor }
                Rectangle {
    ...
    Dialog {
        id: askDlg
        title: (Backend ? Backend.tr("Blora 提问") : "Blora 提问"); modal: true; width: 400; closePolicy: Popup.NoAutoClose
